...
'''
int_average_v1 failed, because 'x + y' would cause overflow error.
---
Z3 does not complain but find a solution(Z3 没有报错并且给出了解决方案), 
because of the integer type in Z3 is infinite and never cause overflow problem.
'''
...
'''
The integer in Java has a Max Value, if it exceeds, it will throw an Overflow Error.
'''
