...
def array_proof():
    ...
    cond = Store(array, index, value)[index] >= value
    ...
    if res == sat:
        print('Store(A, i, x)[i]>=x, SAT')
    else: 
        print('Store(A, i, x)[i]>=x, UNSAT')
...
def array_non_linear_proof():
    ...
    cond = Store(array, index*index - index*index, value)[0] >= value
    ...
    if res == sat:
        print('Store(A, i*i - i*i, x)[0] >= x, SAT')
    else: 
        print('Store(A, i*i - i*i, x)[0] >= x, UNSAT')
