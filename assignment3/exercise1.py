...
E3 = And(Or(P, Q), And(Q, R), And(P, Not(R)))
...
E4 = And(And(P, Not(S), R), And(R, Or(Not(P), And(S, Not(Q)))))
...
print("Here is exercise1-5 begin")
P, Q, R = Bools('P Q R')

E5_base = Or(And(P, Q), R)
solve(E5_base)

E5 = And(E5_base, Not(And(Not(P), Q, R)))
solve(E5)

E5 = And(E5_base, Not(And(P, Not(Q), R)))
solve(E5)

E5 = And(E5_base, Not(And(P, Q, Not(R))))
solve(E5)

E5 = And(E5_base, Not(And(Not(P), Not(Q), R)))
solve(E5)

E5 = And(E5_base, Not(And(Not(P), Q, Not(R))))
solve(E5)

E5 = And(E5_base, Not(And(P, Not(Q), Not(R))))
solve(E5)

E5 = And(E5_base, Not(And(Not(P), Not(Q), Not(R))))
solve(E5)

E5 = And(E5_base, Not(And(P, Q, R)))
solve(E5)

print("Here is exercise1-5 end")
