...
def cnf(nnf_prop: Prop) -> Prop:
    ...
    if isinstance(nnf_prop, PropVar):
        return PropVar(nnf_prop.var)
    if isinstance(nnf_prop, PropImplies):
        return PropOr(cnf(PropNot(nnf_prop.left)), cnf(nnf_prop.right))
