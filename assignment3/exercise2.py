...
print("Exercise 2-3 begin")
P, Q = Bools('P Q')
F = Implies(Implies(P, Q), Implies(Not(Q), Not(P)))
solve(Not(F))
print("Exercise 2-3 end")
...
print("Exercise 2-3 begin")
P, Q, R = Bools('P Q R')
F = Implies(And(Implies(P, Q), R), Implies(Implies(P, Q), Implies(P, R)))
solve(Not(F))
print("Exercise 2-4 end")
